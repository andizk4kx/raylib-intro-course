without warning --Don't bug me about unused variables
/*******************************************************************************************
*
*   PROJECT:        BLOCKS GAME
    ...
    do
        ...
        do
            ...
            then
                ...
                if (IsKeyPressed(KEY_ENTER)) then screen = GAMEPLAY end if 
        ...
        BeginDrawing() 
            ...
            do
                ...
                then
                    ...
                    DrawRectangle(player[p_position][x], player[p_position][y], player[p_size][x], player[p_size][y], BLACK)    -- Draw player bar
                    DrawCircleV(ball[b_position], ball[b_radius], MAROON)   -- Draw ball
                    ...
                    do
                        ...
                        do
                            ...
                            then
                                ...
                                then 
                                    DrawRectangle(bricks[j][i][br_position][x], bricks[j][i][br_position][y], bricks[j][i][br_size][x], bricks[j][i][br_size][y], GRAY) 
                                else 
                                    DrawRectangle(bricks[j][i][br_position][x], bricks[j][i][br_position][y], bricks[j][i][br_size][x], bricks[j][i][br_size][y], DARKGRAY) 
                                end if
                            end if
                        end for
                    end for
